...
from sklearn.metrics import mean_squared_error  # Импорт функции для расчета среднеквадратичной ошибки
...
model = prepare_and_train_model('train/preprocessed_train.csv')  # Обучение модели на предобработанных обучающих данных
